...
export const Dashboard = () => {
  ...
  const mockFisher = {
    id: "FL-2024-001",
    name: "Akenya John",
    email: "john.akenya@email.com",
    phone: "+254 700 123456",
    address: "900 Odera Street, Lake side City, CC 12345",
  ...
  const mockBoats = [
    { id: "BL-001", name: "MV Mariner", type: "Sport Fishing", status: "Active", expiry: "2024-10-15" },
    { id: "BL-002", name: "Auka yamo", type: "Commercial", status: "Pending", expiry: "2024-11-20" }
  ];

  const mockPermits = [
    { id: "SP-001", type: "Nileperch Season", season: "Fall 2024", status: "Active", expiry: "2024-11-30" },
    { id: "SP-002", type: "Dagaa Season", season: "Summer 2024", status: "Expired", expiry: "2024-09-15" }
  ];
